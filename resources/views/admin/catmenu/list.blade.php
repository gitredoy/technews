            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li><a class="text-primary" href="{{route('admin.menu.create')}}">{{$breadcrumb1}}</a></li>
                ...
                <div class="col-md-10">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('admin.menu.create')}}" class="btn btn-sm btn-primary float-right">Create Menu</a>
                        </div>
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::open(['route' => ['admin.category.status','id'=>$list->catnames->id],'method'=>'post']) !!}
                                        @if($list->catnames->status == 1)
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route('admin.menu.destroy',['menu'=>$list->id])}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-sm btn-success" href="{{ route('admin.menu.edit',['menu' => $list->id])}}"><i class="fa fa-pencil-square"></i></a>
