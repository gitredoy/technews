                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route('permission.destroy',['id' => $list->id])}}" method="post">
                                            @csrf
                                            @method('delete')
                                            <a class="btn btn-sm btn-success" href="{{ route('permission.edit',['id' => $list->id])}}"><i class="fa fa-pencil-square"></i></a>
