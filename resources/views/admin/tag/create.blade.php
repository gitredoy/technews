                        ...
                        <div class="card-body">
                            ...
                            <div id="pay-invoice">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    @if ($mode == 'edit')
                                        {!! Form::model($tags,['route' => ['author.tag.update','tag' => $tags->id],'method'=>'PUT']) !!}

                                    @else
                                        {!! Form::open(['route' => 'author.tag.store','method'=>'post']) !!}
                                    ...
                                    @endif
                                        ...
                                        <div>
                                            <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                ...
                                                <span id="payment-button-amount">Create Tag</span>
