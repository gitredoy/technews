            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li><a class="text-primary" href="{{route('author.tag.create')}}">{{$breadcrumb1}}</a></li>
                ...
                <div class="col-md-10">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('author.tag.create')}}" class="btn btn-primary btn-sm float-right">Create Tag</a>
                        </div>
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('author.tag.destroy',['tag' => $list->id])}}" method="post">
                                            @csrf
                                            @method('delete')
                                            <a class="btn btn-sm btn-success" href="{{ route('author.tag.edit',['tag' => $list->id])}}"><i class="fa fa-pencil-square"></i></a>
