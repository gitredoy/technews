...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a class="text-secondary">{{$query}}</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                @if ($posts -> count() == 0)
                    <h2 class="text-capitalize text-primary">No Post Found For This Query <i class="fa fa fa-arrow-right"></i> {{$query}} </h2>
                @else
