        ...
        <div class="container">
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a class="text-secondary">{{$tagPost->name}} ({{$tagPost->posts()->count()}}) </a></li>
                </ol>
            </div>
        </div>
    </section>
                        ...
                        <div class="entity_wrapper">
                            ...
                            <div class="entity_social">
                                <span><i class="fa fa-bars"></i> <a
                                        href="{{route('details.full',['category'=>$post->category->catslug,'id'=>$post->id,'slug'=>$post->slug])}}">Read More</a> </span>
